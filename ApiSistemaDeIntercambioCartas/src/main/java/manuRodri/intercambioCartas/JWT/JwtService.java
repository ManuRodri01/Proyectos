package manuRodri.intercambioCartas.JWT;
...
public class JwtService {
    ...
    //Esto NO debe ir hardcodeado. Dsp debe pasarse de una forma segura
    private final String llave_secreta = "DFGJKSFDGNSDFJKNGSFDJGSDHJFGSDHFSJDFHDSJKFDHSFKJDSFHDSJKFHDSFKHSDFKHSDFKHJDSF";
    ...
    public String generarToken(UserDetails persona) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis()+1000*60*24))//Un dia desde la creacion
