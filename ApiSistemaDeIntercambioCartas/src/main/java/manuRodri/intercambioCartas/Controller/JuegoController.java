...
import manuRodri.intercambioCartas.Service.JuegoService;
...
public class JuegoController {
    ...
    public List<Juego> borrarJuego(@PathVariable("juego-id") int id){
    ...
    public Juego getJuego(@PathVariable("juego-id") int id) {
