...
public class CartaController {
  ...
  public List<RespuestaCartaDTO> getCartasJuego(@PathVariable("juego-id") String juegoId) {
  ...
  public RespuestaCartaDTO getCarta(@PathVariable("carta-id") String cartaId) {
  ...
  public void deleteCarta(@PathVariable("carta-id") String cartaId) {
